...
class Viterbi(HMM):
    ...
    def run_all(self):
        '''Runs Viterbi on all sequences of the file.'''

        for sequence in self.sequences:
            self.run(sequence)
        #self.print_viterbi_mat()

    def run(self, sequence):
        '''Runs Viterbi on the passed in sequence.'''
...
class Forward(HMM):
    ...
    def run_all(self):
        '''Runs Forward on all sequences of the file.'''
